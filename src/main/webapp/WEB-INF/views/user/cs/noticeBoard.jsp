...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/user/templete.css" type="text/css">
    ...
    <link rel="stylesheet" href="/resources/css/cs/noticeBoard.css" type="text/css">
    ...
    <div id="header">
        ...
        <div class="main-logo">
            <div class="home-logo"><img src="/resources/img/logo.png" width="80%" ></a></div>
        </div>
        <div class="main-bar">
        ...
        <div class="menubody">
            <div class="sidebarspace">
                <div class="sidebar"> <!--사이드 바 영역 (필요한만큼 영역 세로로늘리기)-->
                    ...
                    <a href="(메뉴이동"><div class="bar" style="background-color:rgb(240, 240, 240);"><div style="color: rgb(255, 88, 93); background-color:rgb(240, 240, 240);">공지사항</div><i class="fas fa-chevron-right"></i></div></a>
            ...
            <div class="content"><!--메인컨텐츠 (이하 각자 내용 작성)-->
                ...
                <div class="sub-category-area">
                    <button class="sub-category-btn-all" style="background-color: rgb(255, 88, 93); color: white;">전체</button>
                    <button class="sub-category-btn-notice">공지</button>
                    <button class="sub-category-btn-event">이벤트</button>
                </div>
                <!-- search area -->
