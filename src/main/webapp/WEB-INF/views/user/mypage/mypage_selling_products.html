                ...
                <div class="content"><!--메인컨텐츠 (이하 각자 내용 작성)-->
                    ...
                    <div class="item">
                        ...
                        <div class='item_info'>
                            ...
                            <span class="item_status">판매 완료</span>
                            <div class="item_buttons">
                                <button class="btn btn-dark">판매 상세</button>
                                <button class="btn btn-disabled">삭제 불가</button>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="item">
                            ...
                            <div class='item_info'>
                                ...
                                <span class="item_prc">3,300원</span>
                                <span class="item_status">판매 중</span>
                                <div class="item_buttons">
                                    <button class="btn btn-dark">판매 상세</button>
                                <button class="btn btn-dark">내역 삭제</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="item">
                            ...
                            <div class='item_info'>
                                ...
                                <span class="item_prc">3,300원</span>
                                <span class="item_status">판매 승인 대기</span>
                                <div class="item_buttons">
                                    <button class="btn btn-dark">판매 상세</button>
                                    <button class="btn btn-dark">내역 삭제</button>
                                </div>
