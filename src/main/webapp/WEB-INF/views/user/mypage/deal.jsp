                    ...
                    <form class="search-spec" action="/user/mypage/deal" method="get">
                        ...
                        <div class="search-area">
                            <select class="search-select" name="type">
                                <option value="BPS"
                                <c:out value="${pageMaker.cri.type == 'BPS' ? 'selected' : ''}"/>>전체</option>
                                <option value="B"
                                <c:out value="${pageMaker.cri.type eq 'B' ? 'selected' : ''}"/>>브랜드</option>
                                <option value="P"
                                ...
                                <div class="search-form">
                                    <input type="text" class="search-input" name="keyword" value="<c:out value="${pageMaker.cri.keyword}"/>" />
                    ...
                    <div class="item">
                        ...
                        <div class='item_info'>
                            ...
                            <div class="item_buttons">
                                ...
                                <button name="dealCmplBtn" class="btn btn-cmpl" value="<c:out value="${list.gftId}"/>">거래 확정</button>
                                </c:if>
