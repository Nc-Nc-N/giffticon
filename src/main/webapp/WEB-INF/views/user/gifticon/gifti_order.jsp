        ...
        <div id="content">
            ...
            <div id="itemList" class="page_aticle order_goodslist">
                <div class="info_product">
                    ...
                    <div class="short_info">[<c:out value="${gifticon.bname}"/>] <c:out value="${gifticon.pname}"/> 상품을
                        주문합니다.
                    </div>
                </div>
            </div>
                ...
                <tr>
                    ...
                    <td class="noline" style="position:relative">
                        <label class="label_radio checked" id="payCon" style="padding-bottom:4px;">
                            ...
                            현재 보유 콘 <span class="p_pink"> <fmt:formatNumber value="${user.pnt}" type="number"
                                                                            maxFractionDigits="3"/> 콘</span>
                        </label>
                    </td>
                </tr>
                <tr>
                            ...
                            <div>
                                ...
                                <div class="card_event">
                                    ...
                                    <div class="inner_card">
                                        <div><strong class="emph">· 무이자할부 유의사항</strong> 은행계열/체크/기프트/선불/법인/개인사업자 기업카드는 제외
                                        </div>
                                    </div>
                                </div>
                            </div
                ...
                <tr>
                    ...
                    <td>
                        <label class="label_radio" id="cardBenefitChai">
                            ...
                            <img src="https://res.kurly.com/pc/service/order/2001/logo_chi_x2.png" height="18"
                                 alt="Chai 결제">
                            <img class="img_benefit"
                                 src="https://res.kurly.com/pc/service/order/2101/bubble_chai_0301.png" height="20">
                ...
                <tr>
                    ...
                    <td>
                        <label class="label_radio" id="cardBenefitToss">
                            ...
                            <img src="https://res.kurly.com/pc/service/order/1912/toss-logo-signature.svg" height="18"
                                 alt="토스 결제">
                            <img class="img_benefit"
                ...
                <tr>
                    ...
                    <td class="noline">
                        <label class="label_radio" id="cardBenefitNaverpay">
                            ...
                            <img src="//res.kurly.com/pc/service/order/1710/ico_naverpay_v3.png" height="20"
                                 alt="네이버 페이 로고"> <img class="img_benefit"
                                                       src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP4zwAAAgEBAKEeXHUAAAAASUVORK5CYII="
                                                       height="20">
                            <div class="info_benefit"></div>
                        </label>
                ...
                <tr>
                    ...
                    <td>
                        <label class="label_radio" id="cardBenefitPayco">
                            ...
                            <img class="img_benefit"
                                 src="https://res.kurly.com/pc/service/order/2101/bubble_payco_0303.png" height="20">
                            <div class="info_benefit"></div>
                        </label>
                    </td>
                </tr>
            ...
            <div class="orderitem_money_info">
                <table class="money_info_table ">
                    ...
                    <tr class="fst">
                        <th>주문금액</th>
                        <td>
                            <fmt:formatNumber value="${gifticon.dcPrc}" type="number"
                                              maxFractionDigits="3"/><span>원</span>
                        </td>
                    </tr>
                    <tr>
                        <th>콘 사용</th>
                    ...
                    <tr>
                        <th>최종결제금액</th>
                        <td>
                            <span class="final"><fmt:formatNumber value="${gifticon.dcPrc}" type="number"
                                                                  maxFractionDigits="3"/></span> 원
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<script>
    $(document).ready(function () {
        ...
        payMetd.click(function () {
            ...
            $('.useCon').html(numberWithCommas(con));
            $('.final').html(numberWithCommas(money));
        });
            ...
            return new Promise(function (resolve) {
                $.ajax({
                    ...
                    statusCode: {
                        ...
                        204: function () {
                            alert("판매가 취소된 상품입니다. 메인메뉴로 이동합니다.");
                            window.location.href = "/user/home";
                        },
                        417: function () {
                            alert("결제완료 전 상품가격이 변경되었습니다. 가격을 다시 확인해주세요.");
